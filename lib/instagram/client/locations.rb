module Instagram
  class Client
    ...
    module Locations
      ...
      #   @param facebook_place_id [String] A valid Facebook place ID (v2)
      ...
      def location_search(*args)
        ...
        case args.size
        when 1
          facebook_place_id = args.first
          response = get('locations/search', options.merge(:facebook_place_id => facebook_place_id))
        when 2
          lat, lng = args
